...
| `environment_variables.SECRET_KEY` | Flask session-signing key — generate a long random value (e.g. `python -c "import secrets; print(secrets.token_urlsafe(48))"`); the app fails at startup when unset |
